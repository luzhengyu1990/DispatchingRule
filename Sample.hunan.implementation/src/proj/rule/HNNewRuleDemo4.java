...
public class HNNewRuleDemo4 extends BaseCEPRule {
	...
	public void execute(Facts facts) throws Exception {
		...
		if (jiangcanBranchList.size() == 2 && canliBranchList.size() == 2 && lifuBranchList.size() == 2
			...
			System.out.println("×´Ì¬ £º¸ð¸Ú¼ìÐÞ");
			if (loadP <= 1300) {
				if (powerOfQishao < 80) {
			...
			if (jiangcanBranchList.size() < 2) {
				System.out.println("×´Ì¬ £º½­åîÏß¼ìÐÞ");
			}else if(canliBranchList.size() < 2) {
				System.out.println("×´Ì¬ £ºåîå¢Ïß¼ìÐÞ");
			}else if(lifuBranchList.size() < 2) {
				System.out.println("×´Ì¬ £ºå¢¸´Ïß¼ìÐÞ");
			}
			if (loadP <= 1300) {
				if (powerOfQishao < 80) {
			...
			System.out.println("¸ººÉË®Æ½£º"+loadP);
			System.out.println("ÆîÉØÖ±Á÷£º "+powerOfQishao);
