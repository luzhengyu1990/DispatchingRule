...
import proj.rule.HNNewRuleDemo2;

public class HunanCheckProUnitVerticleDemo2 extends CacheEventProcessingUnit {
	protected HazelcastInstance client;
	private Rules rules = new Rules(new HNNewRuleDemo2(this));
	
	public HunanCheckProUnitVerticleDemo2(IESBAdapter adapter, HazelcastInstance client) {
