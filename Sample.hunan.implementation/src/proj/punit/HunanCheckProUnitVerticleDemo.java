...
import proj.rule.HNNewRuleDemo;

public class HunanCheckProUnitVerticleDemo extends CacheEventProcessingUnit {
	protected HazelcastInstance client;
	private Rules rules = new Rules(new HNNewRuleDemo(this));
	
	public HunanCheckProUnitVerticleDemo(IESBAdapter adapter, HazelcastInstance client) {
