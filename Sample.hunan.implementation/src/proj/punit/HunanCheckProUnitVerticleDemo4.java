...
import proj.rule.HNNewRuleDemo4;

public class HunanCheckProUnitVerticleDemo4 extends CacheEventProcessingUnit {
	protected HazelcastInstance client;
	private Rules rules = new Rules(new HNNewRuleDemo4(this));
	
	public HunanCheckProUnitVerticleDemo4(IESBAdapter adapter, HazelcastInstance client) {
